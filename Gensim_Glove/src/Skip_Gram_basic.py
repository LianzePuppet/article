...
import torch
import torch.nn as nn#python构造神经网络的包
from torch.utils.data import DataLoader, Dataset#自由读取
import torch.optim as opt#是一个实现了各种优化算法的库

import matplotlib
# Don't show graph.
matplotlib.use('Agg')#在matplotlib.pyplot库被导入前加“matplotlib.use(‘agg’)”不显示绘图
