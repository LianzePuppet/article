...
@Author: XinZhi Yao
Documentation: https://radimrehurek.com/Glove/models/word2vec.html
"""
import torch
import Glove
...
model_save_file = '../data/Glove.model.bin'
embedding_save_file = '../data/Glove.embedding.txt'
...
class config:
    def __init__(self):
        self.embedding_save_path = '../data/Glove.embedding.txt'
        self.plot_only = 500
